...
difficulty = int(input(("How hard is the school to get into? Select 1-32. Ex: 1 would be the hardest: ")))
...
if num_race == 1:
    ...
    if str(difficulty)[-1] == "1":
        ...
        print(genders[num_gender-2], difficulty_str, "hardest school is", tupleList[0][0], "-", tupleList[0][1], "%")
    else:
